...
The second analysis is that of the learners \cite{smithragan}. The purpose of this analysis is the characterization of the end user of the instruction, which is in this case the middle school students. For this analysis it is important to determine the similarities and differences between the learners. \citeA{smithragan} provide a list of factors which play a role in designing the instruction. These factors are catagorized by stable similarities, stable differences, changing similarities and changing differences, and contain factors like sensory capacities, aptitudes, development processes an d development states.
