...
The instruction is delivered within a Minecraft map, which contains different sections. These sections are the incorporations of the different sub-bodies within the Initial Framework appendix (see page~\pageref{app:framework1}). The map is custom-made in order to meet the needs stemming from the Initial Framework, and provides thereby a tailor-made solution.
