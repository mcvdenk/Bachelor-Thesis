...
After the instruction was entirely developed, it was improved using rapid prototyping, which entails applying short improvement and evaluation cycles. It was evaluated with undergraduate students according the micro-evaluation (see the Evaluation Matchboard appendix on page~\pageref{app:evamatchboard}). The method of evaluation is described more thoroughly in the Method section of the Formative Evaluation on page~\pageref{ch:methodevaluation}. The results of these evaluations were use to improve the map, enhancing the playing experience and improving the learning effectiveness. 

\section{Minor Alterations}
...
\section{Quantum Teleportation Experiment}
...
\subsection{Incorporation of the Teleportation branch}
...
\chapter{The Evaluation Matchboard}
