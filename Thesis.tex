...
The last step of the design phase is to structure the learning objectives in such a way that the instruction can be written. This is achieved by developing a framework, which gives the designer concrete steps for how to develop the instruction.
...
Finally, the teleportation experiment will be taught at a procedural level, which means that the student should learn the steps of a procedure and how to perform the procedure.
