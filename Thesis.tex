...
After these sub-bodies, another tutorial follows, this time teaching the student how to use Quantum Goggles, Anti-Observation Goggles and the Quantum Resetter. The Quantum Resetter is an Automatic Observer which is triggered a very short time, making the Quantum Block losing its current collapsed state of block type.
