...
Realism and Ontologism & 00:05:42 &  & 00:03:19 \\ \hline
...
\end{tabular}
\caption{The average times needed for each section in both the initial and the final version of the instruction, followed by the average time it took a student in total}
\end{center}
\label{timetable}
\end{table}
...
\end{tabular}
\caption{The amount of coded fragments respective to their respondent(-family) and their code(-family)}
\label{tab:codetable}
\end{sidewaystable}
